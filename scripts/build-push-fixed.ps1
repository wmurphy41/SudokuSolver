...
Write-Host "âœ“ Backend image built and pushed successfully!" -ForegroundColor Green
...
Write-Host "âœ“ Web image built and pushed successfully!" -ForegroundColor Green
